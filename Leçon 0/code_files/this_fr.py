...
la beauté à la laideur, l’explicite à l’implicite, 
le simple au complexe et le complexe au compliqué, 
le déroulé à l’imbriqué, l’aéré au compact. 
...
Mieux vaut maintenant que jamais. Cependant jamais est souvent mieux qu’immédiatement. 
Si l’implémentation s’explique difficilement, c’est une mauvaise idée. 
Si l’implémentation s’explique aisément, c’est peut-être une bonne idée.
Les espaces de nommage ! Sacrée bonne idée ! Faisons plus de trucs comme ça.

(Trevian et Cordeau cité dans Cordeau & Pointal, 2018)
'''
